...
* @Versão do phpBB: 3.0.7, v Beta 0.0.1 Outubro/2010 de acordo com as normas do Acordo ortográfico
...
$lang = array_merge($lang, array(
	...
	'DB_HOST_EXPLAIN'					=> 'DSN siginifica Data Source Name. Apenas em instalações ODBC.',
	...
	'FILES_OPTIONAL_EXPLAIN'			=> '<strong>Opcional</strong> - Estes ficheiros, diretorias ou permissões não são necessários. A processo de instalação tentará usar outras técnicas caso eles não existam ou não tenham as permissões adequadas. No entanto, a presença destes ficheiros, diretorias e permissões irá acelerar o processo de instalação.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'				=> 'Todos os ficheiros estão atualizados com a última versão do phpBB. Agora deve <a href="../ucp.php?mode=login&amp;rediret=adm/index.php%3Fi=send_statistics%26mode=send_statistics">autenticar-se no seu Fórum</a> se tudo funciona corretamente. Não se esqueça de apagar, renomear ou mover a diretoria de instalação! Por favor, envie-nos informações atualizadas sobre o servidor e as configurações do Fórum <a href="../ucp.php?mode=login&amp;rediret=adm/index.php%3Fi=send_statistics%26mode=send_statistics">Enviar módulo de estatísticas</a> do seu ACP.',
	...
	'COLLECTED_INFORMATION_EXPLAIN'		=> 'A lista abaixo mostra os ficheiros que necessitam de atualização. Leia as informações abaixo para ver o que tem de fazer para executar uma atualização sem problemas.',
	...
	'FILES_CONFLICT_EXPLAIN'			=> 'Os Ficheiros seguintes são alterados e não representam os respetivos Ficheiros originais da versão anterior. O phpBB determinou que estes Ficheiros criassem conflitos se eles tentarem ser alterados. Por Favor, investigue os conflitos e tente resolvê-los manualmente ou continue a Atualização selecionando o método desejado. Se resolver os conflitos manualmente, verifique os Ficheiros novamente depois de modificados. Pode também Selecionar entre o método desejado para todos os Ficheiros. O primeiro irá resultar num Ficheiro onde as linhas em conflito do seu Ficheiro anterior serão perdidas, e o outro irá resultar na perda das modificações do novo Ficheiro criado.',
	'FILES_MODIFIED'					=> 'Ficheiros Modificados',
	'FILES_MODIFIED_EXPLAIN'			=> 'Os Ficheiros seguintes são alterados e não representam os respetivos Ficheiros originais da versão anterior. O Ficheiro atualizado será uma fusão entre suas modificações e o seu novo Ficheiro.',
	...
	'FILES_NOT_MODIFIED_EXPLAIN'		=> 'Os Ficheiros seguintes não são alterados e representam os seus respetivos Ficheiros originais da versão a qual você deseja atualizar.',
	...
	'INLINE_UPDATE_SUCCESSFUL'			=> 'A Base de Dados foi atualizado com sucesso. Agora tem que continuar com o processo de Atualização.',
	...
	'MAPPING_FILE_STRUCTURE'			=> 'Para facilitar a Atualização aqui, está o local do Ficheiro que mapeia a instalação do phpBB.',
	...
	'NUMBER_OF_FILES_COLLECTED'			=> 'Atualmente foram detetadas diferenças em %1$d de %2$d ficheiros.<br />Por favor aguarde até que todos os ficheiros seja analisados.',
	...
	'PERFORM_DATABASE_UPDATE_EXPLAIN'	=> 'Abaixo encontrará um atalho para o script de atualização da Base de Dados. Este script tem que ser executado separadamente porque a atualização da Base de Dados pode resultar num comportamente inesperado se estiver ligado. A atualização da Base de Dados pode demorar alguns minutos, por favor não pare a execução da mesma. Depois de finalizada a atualização na Base de Dados, feche a janela e continue o processo de atualização.',
	...
	'UPDATE_DATABASE_SCHEMA'			=> 'Atualizando o schema da Base de Dados',
	...
	'UPDATE_INSTRUCTIONS'				=> ' 
		...
		<p>Por Favor, leia <a href="%1$s" title="%1$s">O Anúncio do Lançamento Oficial da Nova Versão</a> antes de continuar o processo de atualização, poderá encontrar informações importantes. Também encontrará disponíveis os atalhos para transferência do pacote, bem como do change log.</p> 
	...
	'UPDATING_TO_LATEST_STABLE'			=> 'Atualizando a Base de Dados para o Novo Sistema',
	'UPDATED_VERSION'					=> 'Versão atualizada',
	'UPLOAD_METHOD'						=> 'Método de envio',

	'UPDATE_DB_SUCCESS'					=> 'A atualização da Base de Dados foi executada com sucesso',
	...
	'VERSION_NOT_UP_TO_DATE'			=> 'A sua instalação do phpBB não está atualizada. Please continue the update process.',
...
$lang = array_merge($lang, array(
	...
	'TOPICS_TOPIC_TITLE'				=> 'Bem vindo ao phpBB 3.0.7',
));
