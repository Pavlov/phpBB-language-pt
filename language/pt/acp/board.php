...
$lang = array_merge($lang, array( 
	...
	'ALLOW_SIG_LINKS_EXPLAIN'		=> 'Se desativado, a tag BBCode <code>[URL]</code> e as URLs mágicas serão Desativadas.',
	'ALLOW_SIG_SMILIES'				=> 'Permitir o uso de Emoções (ícones de Emoção) na Assinatura dos Utilizadores',
	...
	'BOARD_PM_EXPLAIN'				=> 'Ativa/Desativa as Mensagens Privadas para todos os Utilizadores.',
)); 
...
$lang = array_merge($lang, array( 	
	...
	'HOT_THRESHOLD_EXPLAIN'			=> 'Número de Mensagens para tornar um Tópico Popular. (0 = desativados)',
	...
	'QUOTE_DEPTH_LIMIT_EXPLAIN'		=> 'Número náximo de citações que podem ser inseridas numa mensagem. 0 = ilimitadas.',
...
$lang = array_merge($lang, array( 
	...
	'ACC_ACTIVATION_EXPLAIN'			=> 'Determina se o Utilizador terá acesso imediato ao Fórum ou se será necessária uma confirmação. Também pode desativar novos Registos.',

	'NEW_MEMBER_POST_LIMIT'				=> 'Limite de mensagens de Utilizadores Registados Recentemente',
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'		=> 'Os novos utilizadores entram para o Grupo <em>Utilizadores Registados Recentemente</em> até atingirem este número de mensagens. Pode usar este Grupo para impedir que usem as mensagens privadas ou para rever as suas mensagens. <strong>O valor zero desativa esta função.</strong>',
	'NEW_MEMBER_GROUP_DEFAULT'			=> 'Ativar Grupo de Utilizadores Registados Recentemente',
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'	=> 'Se definido como <strong>Sim</strong> e especificado um limite de mensagens, o novo utilizador será colocado no Grupo <em>Utilizadores Registados Recentemente</em>, e esse será também o seu Grupo Padrão. Isso pode ser conveniente se desejar atribuir um Grupo Padrão, Rank e/ou Avatar a estes utilizadores.',
	
	'ACC_ADMIN'							=> 'Administrador',
	'ACC_DISABLE'						=> 'Desativar Registos',
	'ACC_NONE'							=> 'Nenhuma',
	'ACC_USER'							=> 'Utilizador',
//	'A_USER_ADMIN'					=> 'User + Admin', 
...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'				=> 'Aqui pode selecionar e configurar plugins CAPTCHA, que implementam formas de rejeitar as tentativas de registo dos chamados spambots.',
	'AVAILABLE_CAPTCHAS'					=> 'Plugins disponíveis',
	'CAPTCHA_UNAVAILABLE'					=> 'O CAPTCHA não pode ser selecionado enquanto não preencher os requisitos necessários.',
	...
	'CAPTCHA_GD_X_GRID_EXPLAIN'				=> 'Utilize esta configuração para gerar uma imagem GD Captcha mais complexa. 0 irá desativar o ruído de fundo no eixo X.',
	'CAPTCHA_GD_Y_GRID'						=> 'Eixo Y de ruído de fundo do GD Captcha',
	'CAPTCHA_GD_Y_GRID_EXPLAIN'				=> 'Utilize esta configuração para gerar uma imagem GD Captcha mais complexa. 0 irá desativar o ruído de fundo no eixo Y.',
	...
	'CAPTCHA_GD_3D_NOISE_EXPLAIN'			=> 'Adiciona objetos ao CAPTCHA, sobre as letras.',
	...
	'CAPTCHA_CONFIGURE_EXPLAIN'				=> 'Altere as definições para o CAPTCHA selecionado.',
	'CONFIGURE'								=> 'Configuração',
	'CAPTCHA_NO_OPTIONS'					=> 'Este CAPTCHA não tem opções de configuração.',

	'VISUAL_CONFIRM_POST'					=> 'Ativar confirmação visual para mensagens de visitantes',
	'VISUAL_CONFIRM_POST_EXPLAIN'			=> 'Exige aos utilizadores visitantes (anónimos) que introduzam um código aleatório para prevenir mensagens em massa.',
	'VISUAL_CONFIRM_REG'					=> 'Ativar confirmação visual para os registos',
	...
	'VISUAL_CONFIRM_REFRESH'				=> 'Permitir que os utilizadores atualizem a imagem de confirmação',
...
$lang = array_merge($lang, array( 
	...
	'YES_ANON_READ_MARKING_EXPLAIN'			=> 'Armazena a marcação de lido/não lido para convidados. Se desativado, as Mensagens serão sempre lidas por convidados.',
...
$lang = array_merge($lang, array( 
	...
	'LDAP_PASSWORD_EXPLAIN'					=> 'Deixe este campo em branco para acesso anónimo. Caso contrário preencha com a senha do Utilizador indicado. Necessário para Ative Diretory Servers.<br /> <strong>Aviso:</strong> Esta senha será armazenada como texto simples na Base de Dados, visível a todos que podem aceder à Base de Dados ou a quem pode ver esta página de configuração.',
...
$lang = array_merge($lang, array( 
	...
	'SCRIPT_PATH'							=> 'Diretória do script',
...
$lang = array_merge($lang, array( 
	...
	'AUTOLOGIN_LENGTH_EXPLAIN'				=> 'Duração das chaves de acesso automático, (0 = desativado).',
	...
	'FORCE_PASS_CHANGE_EXPLAIN'				=> 'Duração em dias da Senha de acesso ao Fórum. Após este prazo é pedido ao Utilizador que altere a sua Senha. (0 = desativado).',
...
$lang = array_merge($lang, array( 
	...
	'SMTP_PASSWORD_EXPLAIN'					=> 'Só introduza a Senha se o Servidor de SMTP a pedir.<br /> <strong>Aviso:</strong> Esta senha será armazenada como texto simples na Base de Dados, visível a todos que podem aceder à Base de Dados ou a quem pode ver esta página de configuração.',
	'SMTP_PLAIN'							=> 'PLAIN',
...
$lang = array_merge($lang, array( 
	...
	'JAB_PASSWORD_EXPLAIN'					=> '<strong>Aviso:</strong> Esta senha será armazenada como texto simples na Base de Dados, visível a todos que podem aceder à Base de Dados ou a quem pode ver esta página de configuração.',
