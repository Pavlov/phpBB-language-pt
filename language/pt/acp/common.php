...
// Logs 
$lang = array_merge($lang, array( 
	'ACP_ADMIN_LOGS_EXPLAIN'		=> 'Esta é a lista das ações dos Administradores. Pode ordená-la por Utilizador, data, Endereço de IP ou Ação do Registo. Se tiver as permissões adequadas, pode limpar operações individuais ou todo o LOG.',
	...
	'ACP_MOD_LOGS_EXPLAIN'			=> 'Esta é a lista das ações dos Moderadores do Fórum. Pode ordená-la por Utilizador, data, Endereço de IP ou Ação do Registo. Se tiver as permissões adequadas, pode limpar operações individuais ou todo o LOG.',
	'ACP_USERS_LOGS_EXPLAIN'		=> 'Esta é a lista das ações dos Utilizadores do Fórum. Pode ordená-la por Utilizador, data, Endereço de IP ou Ação do Registo. Se tiver as permissões adequadas, pode limpar operações individuais ou todo o LOG.',
...
$lang = array_merge($lang, array( 
	...
	'ADMIN_LOG_INDEX_EXPLAIN'		=> 'Este LOG mostra as últimas cinco Ações dos Administradores.<br />Uma cópia completa do LOG está disponível no item apropriado do Menu ou seguindo o atalho abaixo.',
