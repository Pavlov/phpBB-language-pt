...
$lang = array_merge($lang, array(
	...
	'DISPLAY_ACTIVE_TOPICS_EXPLAIN'	=> 'Se selecionar <strong>Sim</strong>, a ativação de Tópicos nos Subfóruns selecionados será exibida abaixo desta categoria.',

	'EDIT_FORUM'					=> 'Editar Fórum',
	'ENABLE_INDEXING'				=> 'Ativar atributos da Pesquisa',
	'ENABLE_INDEXING_EXPLAIN'		=> 'Se selecionar (Sim), as Mensagens escritas neste Fórum serão indexadas para pesquisas.',
	'ENABLE_POST_REVIEW'			=> 'Ativar Revisão das Mensagens',
	'ENABLE_POST_REVIEW_EXPLAIN'	=> 'Se selecionar (Sim), as Mensagens podem sempre ser revistas pelos seus autores.',

	'ENABLE_QUICK_REPLY'			=> 'Ativar Resposta Rápida',
	'ENABLE_QUICK_REPLY_EXPLAIN'	=> 'Permite a <b>Resposta Rápida</b> neste Fórum. Esta definição não é considerada se a resposta rápida estiver globalmente desativada. A <b>Resposta Rápida</b> só será exibida aos utilizadores que têm permissão para enviar mensagens neste Fórum.',

	'ENABLE_RECENT'					=> 'Exibir Tópicos Ativos',
	'ENABLE_RECENT_EXPLAIN'			=> 'Se selecionar (Sim), os Tópicos escritos neste Fórum serão exibidos na lista de Tópicos ativos.',
	...
	'LIST_INDEX_EXPLAIN'			=> 'Se selecionar (Sim), mostra este Fórum no índice como um atalho na legenda do Fórum Pai.',
	'LIST_SUBFORUMS'				=> 'Mostrar os Subfóruns na legenda',
	'LIST_SUBFORUMS_EXPLAIN'		=> 'Se selecionar (Sim), mostra os Subfóruns deste Fórum no índice como um atalho na legenda do Fórum Pai.',
	'LOCKED'						=> 'Bloqueado',
