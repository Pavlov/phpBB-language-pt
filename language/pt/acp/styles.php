...
/** 
* 
* acp_styles.php [Português]
* 
* @package language 
* @version $Id: styles.php
...
$lang = array_merge($lang, array(
	...
	'DELETE_IMAGESET_EXPLAIN'		=> 'Aqui pode remover o Conjunto de imagens selecionado da Base de Dados. Adicionalmente, se tiver permissão pode selecionar para remover o conjunto do Sistema de Ficheiros. Por favor, note que não é possível anular esta ação. Quando o conjunto de imagens é apagado não é possível recuperá-los. Deve exportar primeiro o Conjunto de Imagens para possível uso futuro.',
	'DELETE_STYLE'					=> 'Apagar Estilo',
	'DELETE_STYLE_EXPLAIN'			=> 'Aqui pode remover o Estilo selecionado. Não pode remover todos os elementos de Estilo daqui. Eles devem ser apagados individualmente por seus respetivos formulários. Por favor, note que não é possível anular esta ação.',
	'DELETE_TEMPLATE'				=> 'Apagar Template',
	'DELETE_TEMPLATE_EXPLAIN'		=> 'Aqui pode remover o Template selecionado da Base de Dados. Adicionalmente, se tiver permissão pode selecionar para remover o conjunto do Sistema de Ficheiros. Por favor, note que não é possível anular esta ação. Quando os Templates são apagados não é possível recuperá-los. Deve exportar primeiro o Template para possível uso futuro.',
	'DELETE_THEME'					=> 'Apagar Tema',
	'DELETE_THEME_EXPLAIN'			=> 'Aqui pode remover o Tema selecionado da Base de Dados. Adicionalmente, se tiver permissão, pode selecionar para remover o Conjunto do Sistema de Ficheiros. Por favor, note que não é possível anular esta ação. Quando os Temas são apagados não é possível recuperá-los. Deve exportar primeiro o Tema para possível uso futuro.',
	'DETAILS'						=> 'Detalhes',
	...
	'IMG_FORUM_UNREAD_LOCKED'		=> 'Fórum Bloqueado com novas Mensagens',
	'IMG_FORUM_UNREAD_SUBFORUM'		=> 'Subfórum com novas Mensagens',
	'IMG_SUBFORUM_READ'				=> 'Subfórum',
	'IMG_SUBFORUM_UNREAD'			=> 'Subfórum com novas Mensagens',
	...
	'IMG_TOPIC_UNREAD_LOCKED'		=> 'Tópico Bloqueado novo',
	'IMG_TOPIC_UNREAD_LOCKED_MINE'	=> 'Tópico Bloqueado enviado para novo',
	...
	'IMG_STICKY_READ_LOCKED_MINE'	=> 'Tópico fixado Bloqueado postado para novo',
	'IMG_STICKY_UNREAD'				=> 'Tópico fixado com novas mensagens',
	'IMG_STICKY_UNREAD_MINE'		=> 'Tópico fixado postado para novo',
	'IMG_STICKY_UNREAD_LOCKED'		=> 'Tópico fixado Bloqueado com novas mensagens',
	'IMG_STICKY_UNREAD_LOCKED_MINE'	=> 'Tópico fixado Bloqueado postado para novo',

	'IMG_ANNOUNCE_READ'				=> 'Anúncio',
	'IMG_ANNOUNCE_READ_MINE'		=> 'Anúncio postado para',
	'IMG_ANNOUNCE_READ_LOCKED'		=> 'Anúncio Bloqueado',
	'IMG_ANNOUNCE_READ_LOCKED_MINE'	=> 'Anúncio Bloqueado postado para',
	'IMG_ANNOUNCE_UNREAD'			=> 'Anúncio com novas mensagens',
	'IMG_ANNOUNCE_UNREAD_MINE'		=> 'Anúncio postado para novo',
	'IMG_ANNOUNCE_UNREAD_LOCKED'	=> 'Anúncio Bloqueado novo mensagem',
	'IMG_ANNOUNCE_UNREAD_LOCKED_MINE'=> 'Anúncio Bloqueado postado para novo',

	'IMG_GLOBAL_READ'				=> 'Global',
	'IMG_GLOBAL_READ_MINE'			=> 'Global postado para',
	'IMG_GLOBAL_READ_LOCKED'		=> 'Global Bloqueado',
	'IMG_GLOBAL_READ_LOCKED_MINE'	=> 'Global Bloqueado postado para',
	'IMG_GLOBAL_UNREAD'				=> 'Global com novas mensagens',
	'IMG_GLOBAL_UNREAD_MINE'		=> 'Global postado para novo',
	'IMG_GLOBAL_UNREAD_LOCKED'		=> 'Global Bloqueado com novas mensagens',
	'IMG_GLOBAL_UNREAD_LOCKED_MINE'	=> 'Global Bloqueado postado para novo',
