...
$help = array(
	...
	array(
		...
		1	=> 'Só os <b>Utilizadores Registados</b> podem enviar <b>emails</b> através do formulário exclusivo do Fórum (se esta função se encontrar ativada). Isso evita o uso malicioso do sistema de email por <b>Utilizadores</b> Anónimos.',
	),
	array(
		0	=> '--',
   ...
   array( 
	...
	array(
		...
		1	=> 'O acesso a algumas seções poderá estar limitado apenas a determinados <b>Utilizadores</b> ou Grupos. Para ver, ler, enviar Mensagens, etc., tem que ter de uma autorização especial. Apenas o Moderador dessa seção e um <b>Administrador</b> podem permitir esse acesso. Entre em contato, caso ache necessário.',
	),
	array(
	...
	array(
		...
		1	=> 'Os <b>Tópicos Fixos</b> aparecem abaixo dos Anúncios, e apenas na primeira página de cada seção. São Tópicos com conteúdo importante e devem ser lidos logo que enviados. Da mesma forma que os Anúncios, está ao critério do <b>Administrador</b> determinar as permissões necessárias para enviar Tópicos Fixos em cada seção.',
	),
	array(
