...
$lang = array_merge($lang, array(
	...
	'QUESTIONS'					=> 'Perguntas',
	'QUESTIONS_EXPLAIN'			=> 'Durante o registo, os utilizadores terão que responder a uma destas perguntas. Para usar este plugin pelo menos uma pergunta deve estar traduzida no Idioma principal. Estas perguntas devem ser de fácil resposta, mas mais dificeis que uma simples pesquisa no Google™ não dê a resposta. Usar perguntas variadas, apresenta melhores resultados. Definir a opção rigorosa se a sua pergunta depende de pontuação ou de capitalização.',
	...
	'QUESTION_STRICT_EXPLAIN'	=> 'Se ativado, maiúscula e espaço em branco farão a diferença.',
